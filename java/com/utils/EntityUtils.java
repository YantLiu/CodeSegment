...
import com.alt.base.common.util.jwt.JWTInfo;
import com.alt.base.common.util.jwt.JWTInfoContext;
...
public class EntityUtils {
    ...
    public static <T> void setCreateInfo(T entity) {
        ...
        JWTInfo jwtInfo = JWTInfoContext.getJWTInfo();
        name = StringUtils.trimToEmpty(jwtInfo.getName());
        id = jwtInfo.getId() == null ? "" : jwtInfo.getId().toString();
